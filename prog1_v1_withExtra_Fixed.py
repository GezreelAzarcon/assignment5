...
import re
#LINE 9 FIXED REMOVED (import.sys)
...
def gradeConvert():
    while True:
        ...
        if gradePercentage1.isalpha():
            ...
            break
    gradePercentage = round(float(gradePercentage1)) # LINE 19 ISSUE FIXED
...
def extra():
    ...
    while True:
        Inc = input('Is "Inc." written in your record? Y/N: ') #LINE 66 FIXED (writter ---> written)
